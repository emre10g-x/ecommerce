export const cities = [
  ...
  { name: "Afyonkarahisar", districts: ["Başmakçı", "Bayat", "Bolvadin", "Çay", "Çobanlar", "Dazkırı", "Dinar", "Emirdağ", "Evciler", "Hocalar", "İhsaniye", "İscehisar", "Kızılören", "Merkez", "Sandıklı", "Sincanlı", "Sultandağı", "Şuhut"] },
  ...
  { name: "Hakkâri", districts: ["Çukurca", "Derecik", "Merkez", "Şemdinli", "Yüksekova"] },
  ...
  { name: "Şanlıurfa", districts: ["Akçakale", "Birecik", "Bozova", "Ceylanpınar", "Eyyübiye", "Halfeti", "Haliliye", "Hilvan", "Karaköprü", "Harran", "Siverek", "Suruç", "Viranşehir"] },
  ...
  { name: "Yalova", districts: ["Altınova", "Armutlu", "Çiftlikköy", "Çınarcık", "Merkez", "Termal"] },
